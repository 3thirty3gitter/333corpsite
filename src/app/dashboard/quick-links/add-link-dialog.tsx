...
export function AddQuickLinkDialog({ onLinkAdded }: AddQuickLinkDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Link added',
        description: `${title} has been added to quick links`
      });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new tool or resource to the quick links dashboard.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              ...
              <div className="col-span-3">
                <Tabs defaultValue="emoji" className="w-full" onValueChange={(v) => setIconType(v)}>
